 ...
 *
 * @param[out] nNanosecondsToWait The number of nanoseconds to wait.
 */
 ...
 * specified interval.
 *
 * @param[out] nMillisecondsToSleep The number of milliseconds to suspend
 *                                  the current thread.
 */
 ...
 */
CAM_API CameraResult CameraReleaseThread(void* handle);

/**
 * This function detaches a thread.
 */
CAM_API CameraResult CameraDetachThread(void* handle);

/**
 * This function terminates a thread
 */
CAM_API CameraResult CameraExitThread(void* handle, int nExitCode);

/**
 * This function joins a thread
 */
CAM_API CameraResult CameraJoinThread(void* handle, void* pExitCode);

/**
 * This function sets priority to a thread
 */
CAM_API CameraResult CameraSetThreadPriority(void* handle, CameraThreadPriorityType nPriority);
