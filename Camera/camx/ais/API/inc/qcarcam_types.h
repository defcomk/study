...
typedef struct
{
    ...
    unsigned char frame_drop_period;   ///< only effective when frame_drop_mode = RAW_PATTERN_MANUAL, max value 32
    unsigned int frame_drop_pattern;   ///< only effective when frame_drop_mode = RAW_PATTERN_MANUAL
