...
public:
    ...
    static const UINT FDHwConfidenceV4V5Max     = 10;       ///< Max confidence value from FD Hw v4, v5
    ...
    ///
    /// @brief  Return face confidence value in the range of 0-1000 from hw output value
    ///
    /// @param  FDHwVersion     FD Hw major version
    /// @param  hwConfidence    Confidence value from HW
    ///
    /// @return Register value for threshold
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
