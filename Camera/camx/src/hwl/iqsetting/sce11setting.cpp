    ...
    VOID*                                                 pOutput)
{
    ...
    if ((NULL != pData) && (NULL != pOutput))
    {
        ...
        for (t = 0; t < 5; t++)
        {
            ...
            dOrig[2][2] = 1.0;
            dDest[0][0] = triangles_original[t]->point1[0];
            dDest[1][0] = triangles_original[t]->point1[1];
            dDest[2][0] = 1.0;
            dDest[0][1] = triangles_original[t]->point3[0];
            dDest[1][1] = triangles_original[t]->point3[1];
            dDest[2][1] = 1.0;
            dDest[0][2] = triangles_original[t]->point2[0];
            dDest[1][2] = triangles_original[t]->point2[1];
            dDest[2][2] = 1.0;
