    ...
    VOID*                                               pOutput)
{
        ...
        (NULL != pOutput))
    {
        ...
        pUnpackedField->rToY    = static_cast<FLOAT>(IQSettingUtils::ClampINT32(
                                      IQSettingUtils::FloatToQNumber(pData->r_to_y, CV12_RGB2Y_DATA_Q_FACTOR),
                                      CV12_RGB2Y_RTOY_MIN,
                                      CV12_RGB2Y_RTOY_MAX));
        pUnpackedField->gToY    = static_cast<FLOAT>(IQSettingUtils::ClampINT32(
                                      IQSettingUtils::FloatToQNumber(pData->g_to_y, CV12_RGB2Y_DATA_Q_FACTOR),
                                      CV12_RGB2Y_GTOY_MIN,
                                      CV12_RGB2Y_GTOY_MAX));
        pUnpackedField->bToY    = static_cast<FLOAT>(IQSettingUtils::ClampINT32(
                                      IQSettingUtils::FloatToQNumber(pData->b_to_y, CV12_RGB2Y_DATA_Q_FACTOR),
                                      CV12_RGB2Y_BTOY_MIN,
                                      CV12_RGB2Y_BTOY_MAX));
        pUnpackedField->yOffset = static_cast<FLOAT>(IQSettingUtils::ClampINT32(
                                      IQSettingUtils::RoundFLOAT(pData->y_offset),
