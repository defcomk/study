    ...
    ASF30UnpackedField*                     pUnpackedField)
{
    ...
    DOUBLE fractional    = frexp(pUnpackedField->initialRSquare, &exp);
    ...
    ASF30UnpackedField*                 pUnpackedField)
{
    ...
    if (NULL != pFDConfig)
    {
        pUnpackedField->faceNum = IQSettingUtils::ClampUINT16(static_cast<UINT16>(pFDConfig->numberOfFace), 0, MAX_FACE_NUM);
