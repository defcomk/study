    ...
    Upscale20UnpackedField*    pUnpackedField)
{
    ...
    if (NULL != pInput && NULL != pUnpackedField)
    {
        ...
        pUnpackedField->upscaleSwConfig.outWidth               = static_cast<UINT16>(pInput->ch0InputWidth);
        pUnpackedField->upscaleSwConfig.outHeight              = static_cast<UINT16>(pInput->ch0InputHeight);
