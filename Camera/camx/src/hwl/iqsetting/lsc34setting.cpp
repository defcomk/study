    ...
    UINT32                                   meshVerticalOffset)
{
        ...
        NULL != pInput->pTintlessAlgo)
    {
        ...
        pInput->pTintlessConfig->tintlessParamConfig.tintlessCorrectionStrength = 255;
        ...
        pInput->pTintlessConfig->statsConfig.saturationLimit[ChannelIndexR] = pInput->pTintlessStats->GetChannelGainThreshold(ChannelIndexR) - 1;
        pInput->pTintlessConfig->statsConfig.saturationLimit[ChannelIndexB] = pInput->pTintlessStats->GetChannelGainThreshold(ChannelIndexB) - 1;
        pInput->pTintlessConfig->statsConfig.saturationLimit[ChannelIndexGR] = pInput->pTintlessStats->GetChannelGainThreshold(ChannelIndexGR) - 1;
        pInput->pTintlessConfig->statsConfig.saturationLimit[ChannelIndexGB] = pInput->pTintlessStats->GetChannelGainThreshold(ChannelIndexGB) - 1;
    ...
    VOID*                                                 pOutput)
{
        ...
        (NULL != pOutput))
    {
        ...
        pUnpackedField->pixel_pattern  = 0;
