...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL BPSABF40Setting::CalculateHWSetting(
...

    {
        ...
        for (i = 0; i < ABF40_NUM_BLOCK_PIX_LEVELS; i++)
        {
            pUnpackedField->blockPixLevel[i] =
                static_cast<UINT16>(IQSettingUtils::ClampUINT32(IQSettingUtils::RoundFLOAT(pData->blkpix_lev_tab.blkpix_lev[i]),
        ...
        for (i = 0; i < ABF40_NUM_ANCHORS; i++)
        {
            ...
            else
            {
                pUnpackedField->RNRShift0[i] =
                    static_cast<UINT16>((log(dd1) + log(4095) - log(bb1)) / log(2));
            }
            ...
            else
            {
                pUnpackedField->RNRShift1[i] =
                    static_cast<INT16>((log(dd1) + log(255) - log(bb1)) / log(2));
            }
            pUnpackedField->RNRShift1[i] =
        ...
        for (i = 0; i < ABF40_NUM_ANCHORS; i++)
        {
            ...
            else
            {
                pUnpackedField->nprsvShift[0][i] =
                    static_cast<UINT16>((log(dd1) + log(255) - log(bb1)) / log(2));
            }
            pUnpackedField->nprsvShift[0][i] =
