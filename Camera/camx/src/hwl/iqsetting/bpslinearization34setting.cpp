...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  bpslinearization34setting.cpp
/// @brief BPS Linearization34 setting calculation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "bpslinearization34setting.h"

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//// BPSLinearization34Setting::CalculateDelta
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void BPSLinearization34Setting::CalculateDelta(
    FLOAT* pLUTP,
    FLOAT* pLUTBase,
    FLOAT* pLUTDelta,
    BOOL   pedestalEnable)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL BPSLinearization34Setting::CalculateHWSetting(
    ...
    VOID*                                                                     pOutput)
{
        ...
        (NULL != pOutput))
    {
        ...
        // @todo (CAMX-1399): add one more input as BPSPipelineCfg
