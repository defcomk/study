...
struct ADRCData
{
    ...
    FLOAT      pchipCoef[MAX_ADRC_LUT_PCHIP_COEF_SIZE];        ///< PCHIP curve
...
struct ISPIQTriggerData
{
    ...
    BOOL      isTMC11Enabled;        ///< Indicates if TMC11 is enabled, in which case TMC10 should be disabled.
...
{
    UINT32 TF10ChromatixSize;    ///< TF chromatix size for nclib
};
...
struct PDPC20IQInput
{
    ...
    UINT32                            zzHDRFirstRBEXP;                          ///< zzHDR First RBEXP
...
struct TMC11InputData
{
    ...
    FLOAT                           IPEGammaOutput[Gamma15TableSize];  ///< Gamma ouput from IPE gamma15 module
};
