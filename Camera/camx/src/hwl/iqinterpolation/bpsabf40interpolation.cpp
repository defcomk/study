...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file  bpsabf40interpolation.cpp
/// @brief BPS ABF40 setting calculation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
    {BPSABF40Interpolation::DRCGainSearchNode, 2},
    {BPSABF40Interpolation::HDRAECSearchNode,  2},
    {BPSABF40Interpolation::AECSearchNode,     2}
};

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSABF40Interpolation::CheckUpdateTrigger
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL BPSABF40Interpolation::CheckUpdateTrigger(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL BPSABF40Interpolation::RunInterpolation(
    ...
    abf_4_0_0::abf40_rgn_dataType* pData )
{
    ...
    if (FALSE != result)
    {
        ...
        result = IQSettingUtils::InterpolateTuningData(&nodeSet[0],
                                                       ...
                                                       ABF40InterpolationLevel,
                                                       BPSABF40Interpolation::DoInterpolation);
    }
...
/// BPSABF40Interpolation::DoInterpolation
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL BPSABF40Interpolation::DoInterpolation(
    VOID* pData1,
    VOID* pData2,
    FLOAT ratio,
    VOID* pResult)
{
    ...
    if ((NULL != pData1) && (NULL != pData2) && (NULL != pResult))
    {
        ...
        {
            result = BPSABF40Interpolation::InterpolationData(pInput1, pInput2, ratio, pOutput);
        }
        else
        {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// BPSABF40Interpolation::InterpolationData
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL BPSABF40Interpolation::InterpolationData(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Interpolation::DRCGainSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT BPSABF40Interpolation::DRCGainSearchNode(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Interpolation::HDRAECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT BPSABF40Interpolation::HDRAECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// BPSABF40Interpolation::AECSearchNode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
UINT BPSABF40Interpolation::AECSearchNode(
    TuningNode* pParentNode,
    VOID*       pTriggerData,
    TuningNode* pChildNode)
{
