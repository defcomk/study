    ...
    CropType cropType)
{
    ...
    CAMX_LOG_VERBOSE(CamxLogGroupISP, "Path %d, cropType:%d, MNDS %d * %d, Crop Window[%d, %d, %d, %d] Stream %dx%d",
                     m_output, cropType,
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::ConfigureDisplayFullLumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop10::ConfigureDisplayFullLumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::ConfigureDisplayFullChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop10::ConfigureDisplayFullChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::ConfigureDisplayDS4LumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop10::ConfigureDisplayDS4LumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::ConfigureDisplayDS4ChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop10::ConfigureDisplayDS4ChromaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::ConfigureDisplayDS16LumaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop10::ConfigureDisplayDS16LumaRegisters(
    CropInfo* pCrop)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IFECrop10::ConfigureDisplayDS16ChromaRegisters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
VOID IFECrop10::ConfigureDisplayDS16ChromaRegisters(
    CropInfo* pCrop)
{
    ...
    CropType    cropType)
{
    ...
    if ((cropLeft + cropWidth) > m_pState->scalerOutput.dimension.width)
    {
        ...
        {
            cropLeft = m_pState->scalerOutput.dimension.width - cropWidth;
        }
        else
        {
            cropWidth = m_pState->scalerOutput.dimension.width - cropLeft;
        }
    }
    ...
    if ((cropTop + cropHeight) > m_pState->scalerOutput.dimension.height)
    {
        ...
        {
            cropTop = m_pState->scalerOutput.dimension.height - cropHeight;
        }
        else
        {
            cropHeight = m_pState->scalerOutput.dimension.height - cropTop;
        }
    }
    ...
    if ((TRUE == m_pInputData->pStripeConfig->overwriteStripes) &&
        ((DS4Output == m_output)  || (DS16Output == m_output) ||
         (DisplayDS4Output == m_output) || (DisplayDS16Output == m_output)))
    {
        pCrop->firstLine = precalculatedCrop.firstLine;
        pCrop->lastLine  = precalculatedCrop.lastLine;
    }

    if (static_cast<UINT32>(m_pState->scalerOutput.scalingFactor * 100) <= IFECropScalingThreshold)
    {
        ...
        // Applied crop corresponds to crop window with respect to CAMIF/Sensor, Need to consider scale factor
        // Ensure width and height are aligned with even number
        m_pState->appliedCropInfo.width  = Utils::EvenFloorUINT32(((pCrop->lastPixel - pCrop->firstPixel) + 1) *
                                                                  m_pState->scalerOutput.scalingFactor);
        m_pState->appliedCropInfo.height = Utils::EvenFloorUINT32(((pCrop->lastLine - pCrop->firstLine) + 1) *
                                                                  m_pState->scalerOutput.scalingFactor);
    }
    else
    {
        ...
        else
        {
            ...
            // Ensure width and height are aligned with even number
            m_pState->appliedCropInfo.width  = Utils::EvenFloorUINT32(m_pState->modifiedCropWindow.width);
            m_pState->appliedCropInfo.height = Utils::EvenFloorUINT32(m_pState->modifiedCropWindow.height);
        }
    }

    CAMX_LOG_VERBOSE(CamxLogGroupISP, "Path %d, cropType=%d, Luma Crop window [%d, %d, %d, %d] app [%d %d %d %d]",
                         m_output,
                         cropType,
                         pCrop->firstPixel,
                         pCrop->lastPixel,
                         pCrop->firstLine,
                         pCrop->lastLine,
                         m_pState->appliedCropInfo.left,
                         m_pState->appliedCropInfo.top,
                         m_pState->appliedCropInfo.width,
                         m_pState->appliedCropInfo.height);
}
    ...
    ISPInputData* pInputData)
{
    ...
    if (TRUE == m_pInputData->pStripeConfig->overwriteStripes)
    {
            ...
            (CropTypeFromRight == pInputData->pStripeConfig->cropType)))
        {
            ...
            {
                ISPInternalData*    pFrameLevel = pInputData->pStripeConfig->pFrameLevelData->pFrameData;
                lumaCrop.firstPixel   = pInputData->pStripeConfig->pStripeOutput->outCrop_Y_disp.firstOut;
                lumaCrop.lastPixel    = pInputData->pStripeConfig->pStripeOutput->outCrop_Y_disp.lastOut;
                lumaCrop.firstLine    = pFrameLevel->dispOutCrop.firstLine;
                lumaCrop.lastLine     = pFrameLevel->dispOutCrop.lastLine;
                chromaCrop.firstPixel = pInputData->pStripeConfig->pStripeOutput->outCrop_C_disp.firstOut * 2;
                chromaCrop.lastPixel  = pInputData->pStripeConfig->pStripeOutput->outCrop_C_disp.lastOut * 2 + 1;
            ...
            {
                lumaCrop.firstPixel   = pInputData->pStripeConfig->pStripeOutput->outCrop_1to4_Y_disp.firstOut;
                lumaCrop.lastPixel    = pInputData->pStripeConfig->pStripeOutput->outCrop_1to4_Y_disp.lastOut;
                chromaCrop.firstPixel = pInputData->pStripeConfig->pStripeOutput->outCrop_1to4_C_disp.firstOut * 2;
                chromaCrop.lastPixel  = pInputData->pStripeConfig->pStripeOutput->outCrop_1to4_C_disp.lastOut * 2 + 1;
            ...
            {
                lumaCrop.firstPixel   = pInputData->pStripeConfig->pStripeOutput->outCrop_1to16_Y_disp.firstOut;
                lumaCrop.lastPixel    = pInputData->pStripeConfig->pStripeOutput->outCrop_1to16_Y_disp.lastOut;
                chromaCrop.firstPixel = pInputData->pStripeConfig->pStripeOutput->outCrop_1to16_C_disp.firstOut * 2;
                chromaCrop.lastPixel  = pInputData->pStripeConfig->pStripeOutput->outCrop_1to16_C_disp.lastOut * 2 + 1;
    ...
    ISPInputData* pInputData)
{
    ...
    switch (m_output)
    {
        ...
        case DisplayFullOutput:
            pCropModuleEnable->displayFullLumaCropRoundClampConfig.bitfields.CROP_EN     = m_moduleEnable;
            pCropModuleEnable->displayFullChromaCropRoundClampConfig.bitfields.CROP_EN   = m_moduleEnable;
            ...
            else
            {
                ...
                {
                    pInputData->pCalculatedData->dispPreCropInfo.YCrop.firstPixel =
                        pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to4_Y_disp.firstOut;
                    pInputData->pCalculatedData->dispPreCropInfo.YCrop.lastPixel  =
                        pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to4_Y_disp.lastOut;

                    pInputData->pCalculatedData->dispPreCropInfo.CrCrop.firstPixel =
                        pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to4_C_disp.firstOut * 2;
                    pInputData->pCalculatedData->dispPreCropInfo.CrCrop.lastPixel  =
                        pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to4_C_disp.lastOut * 2 + 1;
                }
            }
            break;

        case DisplayDS4Output:
            pCropModuleEnable->displayDS4LumaCropRoundClampConfig.bitfields.CROP_EN     = m_moduleEnable;
            pCropModuleEnable->displayDS4ChromaCropRoundClampConfig.bitfields.CROP_EN   = m_moduleEnable;
            ...
            if (TRUE == pInputData->pStripeConfig->overwriteStripes)
            {
                pInputData->pCalculatedData->dispPreCropInfoDS16.YCrop.firstPixel =
                    pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to16_Y_disp.firstOut;
                pInputData->pCalculatedData->dispPreCropInfoDS16.YCrop.lastPixel  =
                    pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to16_Y_disp.lastOut;

                pInputData->pCalculatedData->dispPreCropInfoDS16.CrCrop.firstPixel =
                    pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to16_C_disp.firstOut * 2;
                pInputData->pCalculatedData->dispPreCropInfoDS16.CrCrop.lastPixel  =
                    pInputData->pStripeConfig->pStripeOutput->preDS4Crop_1to16_C_disp.lastOut * 2 + 1;
            }

            // PostCrop is disabled if PreCrop is enabled
            if (CropTypeCentered == pInputData->pStripeConfig->cropType)
            {
                if (0 == pCropModuleEnable->frameProcessingDisplayModuleConfig.bitfields.DS_4TO1_1ST_PRE_CROP_EN)
                {
                    pCropModuleEnable->frameProcessingDisplayModuleConfig.bitfields.DS_4TO1_1ST_POST_CROP_EN = m_moduleEnable;
                }
            }
            else
            {
        ...
        case DisplayDS16Output:
            pCropModuleEnable->displayDS16LumaCropRoundClampConfig.bitfields.CROP_EN     = m_moduleEnable;
            pCropModuleEnable->displayDS16ChromaCropRoundClampConfig.bitfields.CROP_EN   = m_moduleEnable;
            ...
            if (CropTypeCentered == pInputData->pStripeConfig->cropType)
            {
                if (0 == pCropModuleEnable->frameProcessingDisplayModuleConfig.bitfields.DS_4TO1_1ST_PRE_CROP_EN)
                {
                    pCropModuleEnable->frameProcessingDisplayModuleConfig.bitfields.DS_4TO1_2ND_POST_CROP_EN = m_moduleEnable;
                }
            }
            else
            {
        ...
        case PixelRawOutput:
            pCropModuleEnable->frameProcessingModuleConfig.bitfields.PIXEL_RAW_DUMP_EN = m_moduleEnable;
            break;
