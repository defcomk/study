...
CamxResult SWTMC11::Initialize()
{
    ...
    {
        CAMX_LOG_VERBOSE(CamxLogGroupISP, "Not support Gamma15 pre-calculation in TMC 1.1, use hardcoded gamma table");
    }
    ...
    ISPInputData* pInputData)
{
    ...
    if (NULL != m_pChromatix)
    {
            ...
            (m_pChromatix->SymbolTableID != m_dependenceData.pChromatix->SymbolTableID))
        {
            ...
            isChanged                   = TRUE;
            CAMX_LOG_VERBOSE(CamxLogGroupISP, "TMC 1.1 : m_pChromatix->enable_section.tmc_enable = %d", m_moduleEnable);
        }
    }
    else
    {
    ...
    pInputData->triggerData.isTMC11Enabled = m_moduleEnable;
    ...
    ISPInputData* pInputData)
{
    ...
    {
        pGammaOutput = &gamma15table[0];
        CAMX_LOG_VERBOSE(CamxLogGroupISP, "TMC 1.1 : Gamma15 pre-calculation is not enabled, use hardcoded gamma table");
    }
    ...
    {
        CAMX_LOG_ERROR(CamxLogGroupISP, "TMC 1.1 : cannot get input gamma for TMC 1.1");
    }
