    ...
    ISPInputData* pInputData)
{
    ...
    if (NULL != pInputData)
    {
        ...
        {
            pInputData->pStripingInput->stripingInput.tapoffPoint_hvx = static_cast<int16_t>(m_tapPoint);
            pInputData->pStripingInput->stripingInput.tapoffPoint_hvx = static_cast<int16_t>(m_HVXParams.HVXInfo.kernelSize);
