...
CamxResult BPSHDRBHist13Stats::Create(
    BPSStatsModuleCreateData* pCreateData)
{
    ...
    ISPInputData* pInputData)
{
    ...
    pBPSIQSettings->bayerHistogramParameters.bihistRgnHNum      = m_moduleSetting.regionHorizNum;
    pBPSIQSettings->bayerHistogramParameters.bihistRgnVNum      = m_moduleSetting.regionVertNum;
    ...
    pInputData->pCalculatedData->metadata.HDRBHistStatsConfig.numBins           = MaxBHistBinNum;
}
...
BPSHDRBHist13Stats::BPSHDRBHist13Stats()
{
    m_type         = ISPStatsModuleType::BPSAWBBG;
    m_moduleEnable = TRUE;
}
