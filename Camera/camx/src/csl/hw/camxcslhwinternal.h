...
static const INT32  CSLHwMaxKMDNumDevices  = CAM_REQ_MGR_MAX_HANDLES;   ///< Maximum number of KMD devices managed by CSL
static const INT32  CSLHwMaxNumSessions    = CAM_REQ_MGR_MAX_HANDLES;   ///< Maximum number of sessions managed by CSL
...
///
/// @param  pSession    Pointer to the session to be operated on.
/// @param  syncId      CSL Sync Id which KMD needs to cancel for CRM
/// @param  requestId   Input Capture request id which KMD need to cancel for offline path
/// @param  flushAll    TRUE in case of flush needs to be performed and FALSE in case to cancel a specific request
///
/// @return CamxResult success or failure status
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
