    ...
    CSLSyncLinkMode    syncMode)
{
    CAMX_ASSERT_MESSAGE(NULL != g_pCSLModeManager, "CSL not initialized");
    CSLJumpTable* pJumpTable = g_pCSLModeManager->GetJumpTable();
    return pJumpTable->CSLOpenRequest(hCSL, hLink, requestId, bubble, syncMode);
}
    ...
    UINT64             requestId)
{
    CAMX_ASSERT_MESSAGE(NULL != g_pCSLModeManager, "CSL not initialized");
    CSLJumpTable* pJumpTable = g_pCSLModeManager->GetJumpTable();
    return pJumpTable->CSLCancelRequest(hCSL, hLink, cslSyncId, requestId);
}
    ...
    UINT64    lastFlushedRequestId)
{
    ...
    CAMX_ASSERT_MESSAGE(NULL != g_pCSLModeManager, "CSL not initialized");
    CSLJumpTable* pJumpTable = g_pCSLModeManager->GetJumpTable();
    return pJumpTable->CSLFlushLock(hCSL, lastFlushedSyncId, lastFlushedRequestId);
}
    ...
    VOID*           pUserData)
{
    ...
    CAMX_ASSERT_MESSAGE(NULL != g_pCSLModeManager, "CSL not initialized");
    CSLJumpTable* pJumpTable = g_pCSLModeManager->GetJumpTable();
    return pJumpTable->CSLFenceAsyncWait(hFence, handler, pUserData);
}
    ...
    VOID*           pUserData)
{
    ...
    CAMX_ASSERT_MESSAGE(NULL != g_pCSLModeManager, "CSL not initialized");
    CSLJumpTable* pJumpTable = g_pCSLModeManager->GetJumpTable();
    return pJumpTable->CSLFenceAsyncCancel(hFence, handler, pUserData);
}
    ...
    CSLFenceResult  fenceResult)
{
    ...
    CAMX_ASSERT_MESSAGE(NULL != g_pCSLModeManager, "CSL not initialized");
    CSLJumpTable* pJumpTable = g_pCSLModeManager->GetJumpTable();
    return pJumpTable->CSLFenceSignal(hFence, fenceResult);
}
