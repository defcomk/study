...
typedef enum
{
    CSLICPResourceIDBPS = 1,        ///< Indicates BPS resource
    CSLICPResourceIDIPERealTime,    ///< Indicates IPE realtime resource
    CSLICPResourceIDIPENonRealTime, ///< Indicates IPE Non Realtime resource
...
typedef enum
{
    ...
    CSLIPEOutputPortIdMaxNumPortResources                       ///< To use as the number of port resources
} CSLIPEOutputPortId;
