...
static const UINT MaxIncrBufMappings = 3;    ///< Maximum number of incremental mappings allowed for a given buffer
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// @return MemPoolBufferHandle.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    MemPoolBufferHandle GetBufferFromPool(
        MemPoolBufferManager* pMemPoolBufMgr,
    ...
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID PrintMemPoolGroupState() const;
...
private:
    ...
    MemPoolGroup(const MemPoolGroup& other)            = delete;
    MemPoolGroup& operator=(const MemPoolGroup& other) = delete;
