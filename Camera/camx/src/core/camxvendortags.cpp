...
static VendorTagData g_VendorTagIHDRControl[] =
{
    { "state_ihdr_snapshot",   VendorTagType::Int32, 1 }
};
...
static VendorTagSectionData g_CamXVendorTagSections[] =
{
    ...
    {
        "com.qti.ihdr_control",  0,
        CAMX_ARRAY_SIZE(g_VendorTagIHDRControl), g_VendorTagIHDRControl,
        TagSectionVisibility::TagSectionVisibleToOEM
    },
};
...
VOID VendorTagManager::PopulateControlVendorTagId()
{
    ...
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICAInPerspectiveTransform",
                           &g_controlVendorTag.ICAInPerspectiveTransformVendorTag);
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICAInGridTransform",
                           &g_controlVendorTag.ICAInGridTransformVendorTag);
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICAInInterpolationParams",
                           &g_controlVendorTag.ICAInInterpolationParamVendorTag);
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICARefPerspectiveTransform",
                           &g_controlVendorTag.ICARefPerspectiveTransformVendorTag);
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICARefGridTransform",
                           &g_controlVendorTag.ICARefGridTransformVendorTag);
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICARefInterpolationParams",
                           &g_controlVendorTag.ICARefInterpolationParamVendorTag);
    ...
    QueryVendorTagLocation("org.quic.camera2.ipeicaconfigs",
                           "ICAReferenceParams",
                           &g_controlVendorTag.ICAReferenceVendorTag);
