...
public:
    ...
    public:
        ...
        /// @brief  Updates the iterator to point to the next element.
        ///
        /// @param  entry  Entry which will be filled by the callee
        ///
        /// @return None
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        CamxResult GetEntry(
    ...
    private:
        ...
        /// @brief  Constructor
        ///
        /// @param  metaBuffer  Reference to the metabuffer object for which the iterator is defined
        ///
        /// @return None
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        explicit Iterator(
        ...
        Iterator(const Iterator& pOther) = delete;
        Iterator(const Iterator&& pOther) = delete;
        Iterator& operator=(const Iterator& pOther) = delete;
        Iterator& operator=(const Iterator&& pOther) = delete;

        MetaBuffer&     m_metaBuffer;   ///< Reference to the metabuffer object
    ...
    ///
    /// @param  metadataTag     Metadata tag to be queried
    /// @param  entry           The structure to be filled
    /// @param  needLock        Indicates if the access needs to be protected
    ///
    /// @return CamxResultSuccess if successful.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///
    /// @param  metadataTag   Metadata tag to be queried
    /// @param  count         Count of metadata tag
    /// @param  needLock      Indicates if the access needs to be protected
    ///
    /// @return pointer to the data.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
    MetaBuffer(const MetaBuffer& pOther) = delete;
    MetaBuffer(const MetaBuffer&& pOther) = delete;
    MetaBuffer& operator=(const MetaBuffer& pOther) = delete;
    MetaBuffer& operator=(const MetaBuffer&& pOther) = delete;
    ...
    /// @param  regionIndex Index of the memory region in the vector
    ///
    /// @return CamxResultSuccess if successful.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private:
        Map(const Map& pOther)             = delete;
        Map(const Map&& pOther)            = delete;
        Map& operator=(const Map& pOther)  = delete;
        Map& operator=(const Map&& pOther) = delete;
    };
    ...
    private:
        MapIterator(const MapIterator& pOther) = delete;
        MapIterator(const MapIterator&& pOther) = delete;
        MapIterator& operator=(const MapIterator& pOther) = delete;
        MapIterator& operator=(const MapIterator&& pOther) = delete;
    };
    ...
    public:
        ...
        public:
            ...
            ///
            /// @param  map Reference to the hashmap
            ///
            /// @return None
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private:
            ...
            HashIterator(const HashIterator& pOther) = delete;
            HashIterator(const HashIterator&& pOther) = delete;
            HashIterator& operator=(const HashIterator& pOther) = delete;
            HashIterator& operator=(const HashIterator&& pOther) = delete;

            HashMap&                                      m_map;      ///< Reference to the hashmap
    ...
    private:
        ...
        HashMap(const HashMap& pOther)              = delete;
        HashMap(const HashMap&& pOther)             = delete;
        HashMap& operator=(const HashMap& pOther)   = delete;
        HashMap& operator=(const HashMap&& pOther)  = delete;
    };
    ...
    public:
        ...
        private:
            LinearIterator(const LinearIterator& pOther) = delete;
            LinearIterator(const LinearIterator&& pOther) = delete;
            LinearIterator& operator=(const LinearIterator& pOther) = delete;
            LinearIterator& operator=(const LinearIterator&& pOther) = delete;

            UINT32      m_mapIndex; ///< Current index of the iterator for the hashmap
            LinearMap&  m_map;      ///< Reference to the hashmap
    ...
    private:
        ...
        LinearMap(const LinearMap& pOther)             = delete;
        LinearMap(const LinearMap&& pOther)            = delete;
        LinearMap& operator=(const LinearMap& pOther)  = delete;
        LinearMap& operator=(const LinearMap&& pOther) = delete;
    };
