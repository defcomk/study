...
private:
    ...
    CHIHANDLE            m_hNodeSession;                            ///< The node session identifier return by creating the
                                                                    ///  CHI node
    UINT                 m_numInputPort;                            ///< The number of input port
    CHINODEBUFFERHANDLE* m_phInputBuffer;                           ///< The pointer to array of CHIBUFFERHANDLE for input
                                                                    ///  buffer, the size of array will be determined by
                                                                    ///  m_numInputPort
    UINT                 m_numOutputPort;                           ///< The number of output port
    CHINODEBUFFERHANDLE* m_phOutputBuffer;                          ///< The pointer to array of CHIBUFFERHANDLE for output
                                                                    ///  buffer, the size of array will be determined by
                                                                    ///  m_numOutputPort
