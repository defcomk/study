            ...
            if ((NULL != pMetadata) && (NULL != cameraInfo.pPlatformCaps) && (NULL != cameraInfo.pSensorCaps))
            {
                ...
                for (SIZE_T key = 0; key < numAvailableRequest; key++)
                {
                    switch (cameraInfo.pPlatformCaps->requestKeys[key])
                    {
                        ...
                        ////////////////////////////////////////////////////////////////////////////////////////////////////////
                        case DemosaicMode:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "DemosaicMode metadata not supported");
                            break;
                        ...
                        case EdgeStrength:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "EdgeStrength metadata not supported");
                            break;
                        ...
                        case FlashFiringTime:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "FlashFiringPower and FlashFiringTime metadata not supported");
                            break;
                        ...
                        case JPEGThumbnailSize:
                            CAMX_LOG_WARN(CamxLogGroupHAL,
                                          ...
                                          "JPEGOrientation, JPEGQuality, JPEGThumbnailQuality, JPEGThumbnailSize "
                        ...
                        case NoiseReductionStrength:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "NoiseReductionStrength metadata not supported");
                            break;
                        ...
                        case SensorTestPatternData:
                            CAMX_ASSERT(SensorTestPatternModeOff == defaultRequest.sensorTestPatternMode);
                            CAMX_LOG_WARN(CamxLogGroupHAL, "SensorTestPatternData metadata not supported");
                            break;
                        ...
                        case SensorTimestamp:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "SensorTimestamp metadata not supported");
                            break;
                        ...
                        case ShadingStrength:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "ShadingStrength metadata not supported");
                            break;
                        ...
                        case StatisticsHistogramMode:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "StatisticsHistogramMode metadata not supported");
                            break;

                        case StatisticsSharpnessMapMode:
                            CAMX_LOG_WARN(CamxLogGroupHAL, "StatisticsSharpnessMapMode metadata not supported");
                            break;
                        ...
                        case LedTransmit:
                            ...
                            CAMX_LOG_WARN(CamxLogGroupHAL, "LedTransmit metadata not supported");
                            break;
                        ...
                        case ReprocessEffectiveExposureFactor:
                            ...
                            CAMX_LOG_WARN(CamxLogGroupHAL, "ReprocessEffectiveExposureFactor metadata not supported");
                            break;

                        default:
                            CAMX_ASSERT_ALWAYS_MESSAGE("Invalid request metadata key: %d",
