...
static const UINT   DebugDataPartitionsIPE  = 3; // This does NOT consider scaler data in MFNR use-case
static const UINT   DebugDataPartitionsBPS  = 2; // For MFNR use-case
