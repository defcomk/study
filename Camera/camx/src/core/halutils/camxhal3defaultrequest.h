...
private:
        ...
        const HwCameraInfo*          pCameraInfo)
    {
        ...
        pDefaultRequest->scalerCropRegion.width     = pCameraInfo->pSensorCaps->activeArraySize.width;
        pDefaultRequest->scalerCropRegion.height    = pCameraInfo->pSensorCaps->activeArraySize.height;
    }
