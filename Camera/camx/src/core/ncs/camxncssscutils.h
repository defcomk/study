...
// NOWHINE FILE PR007b: needed by STL library
...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool operator==(
        const SensorUid& rhs) const
    {
        return (m_low == rhs.m_low && m_high == rhs.m_high);
    }

    SensorUid& operator= (const SensorUid& suid) = default;
...
private:
    ...
    SensorUid(const SensorUid& suid)             = delete;
};

using suid_event_function = std::function<void(const std::string& datatype, const std::vector<SensorUid>& suids)>;
...
private:
    ...
    SuidLookup(const SuidLookup& lookup)                  = delete;
    SuidLookup& operator= (const SuidLookup& lookup) = delete;
