...
static const UINT QSEEConnectionTimeout = 1000;     ///< QSEE connection timeout period in ms
...
static const UINT QSEECallbacksTimeout  = 500;      ///< QSEE connection timeout period in ms
...
public:
    ...
    ///
    /// @return NCSIntfState of this interface object
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    NCSIntfState UpdateIntfState(
        VOID* pPayload);
...
private:
    ...
    ///
    /// @param  suid SUID of the sensor
    ///
    /// @return Sensor conn index, -1 for error, unable to find
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // NOWHINE CP010: Platform sensor struture
        ...
        const SensorUid &suid)
    {
        ...
        {
            if (m_sensorConnList[i].suid == suid)
            {
    ...
    ///
    /// @param  suid    Sensor SUID
    /// @param  pbEvent Sensor payload containing the sensor data
    ///
    /// @return CamxResultSuccess on successful execution
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // NOWHINE CP010: Platform sensor struture
    CamxResult FillSensorData(
        const SensorUid                             &suid,
        const sns_client_event_msg_sns_client_event &pbEvent);
    ...
    ///
    /// @param  suid    Sensor SUID
    /// @param  pbEvent Sensor payload containing the sensor calibration data
    ///
    /// @return CamxResultSuccess on successful execution
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // NOWHINE CP010: Platform sensor struture
    ...
    NCSIntfQSEE(const NCSIntfQSEE& NCSIntfQSEE)             = delete;
    NCSIntfQSEE& operator= (const NCSIntfQSEE& NCSIntfQSEE) = delete;
    ...
    ChiContext*                  m_pChiContext;                               ///< Pointer to the chi context
