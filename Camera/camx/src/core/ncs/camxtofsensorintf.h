...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static TOFSensorIntf* GetInstance(
    ...
    /// @return CamxResultSuccess on success
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult TearDownTOFIntfLink();
...
private:
    ...
    TOFSensorIntf(const TOFSensorIntf& TOFSensorIntf)             = delete;
    TOFSensorIntf& operator= (const TOFSensorIntf& TOFSensorIntf) = delete;

    static TOFSensorIntf    s_laserSensor;             ///< Singleton Laser Sensor Object
    ChiContext*             m_pChiContext;             ///< Pointer to Chi Context
