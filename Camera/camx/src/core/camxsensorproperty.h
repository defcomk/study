...
/// @brief Maximum sensor capabilities supported per sensor resolution (Normal, HFR, HDR, PDAF, QUADCFA, ZZHDR, FASTAEC, DEPTH, SHDR)
static const UINT MaxSensorCapabilityCount       = 9;
...
struct SensorMode
{
    ...
    SensorCropInfo      cropInfo;                                     ///< Crop info for this mode
...
{
    UINT32 vtPixelClk;          ///< Video domain timing clock value
