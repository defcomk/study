...
// Override settings
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Primarily an example for how to use the VOID* in ExtendOpen and ModifySettings
...
struct ChiOverrideExtendOpen
{
    ...
    ChiOverrideToken*   pTokens;    ///< pointer to tokens
};

/// @brief Primarily an example for how to use the VOID* in ExtendClose and ModifySettings
...
void GenerateExtendOpenData(
    UINT32 numTokens,
    ChiOverrideExtendOpen* pToken);
/// NOWHINE DC002a : Sample code
void GenerateExtendCloseData(
    UINT32 numTokens,
    ChiOverrideExtendClose* pToken);
/// @brief Sample code for using ExtendOpen and ModifySettings
/// NOWHINE DC002a : Sample code
void GenerateModifySettingsData(
    ChiOverrideModifySetting* pToken);
