...
struct MappedControlVendorTag
{
    ...
    UINT32 ICAInPerspectiveTransformVendorTag;     ///< Tag ID for ICA In Perspective Transform Vendor Tag
    UINT32 ICAInGridTransformVendorTag;            ///< Tag ID for ICA In Grid Transform Vendor Tag
    UINT32 ICAInInterpolationParamVendorTag;       ///< Tag ID for ICA In Interpolation Param Vendor Tag
    UINT32 ICARefPerspectiveTransformVendorTag;    ///< Tag ID for ICA Reference Perspective Transform Vendor Tag
    UINT32 ICARefGridTransformVendorTag;           ///< Tag ID for ICA Reference Grid Transform Vendor Tag
    UINT32 ICARefInterpolationParamVendorTag;      ///< Tag ID for ICA Reference Interpolation Param Vendor Tag
    ...
    UINT32 ICAReferenceVendorTag;                  ///< Tag ID for ICA Reference Vendor Tag
...
/// @brief org.quic.camera2.asdresults section for ASD results
static VendorTagData g_VendorTagSectionASDResults[] =
{
    { VendorTagNameASDResults,  VendorTagType::Byte, sizeof(ASDOutput) },
};
...
CAMX_INLINE UINT32 SectionTagToIndex(UINT32 tag) {
    ...
    ASSERT(index < CAMX_ARRAY_SIZE(SectionLinearTagLUT));
