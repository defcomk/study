...
private:
    ...
    MetadataSlot(const MetadataSlot& pMetadataSlot) = delete;
    MetadataSlot(const MetadataSlot&& pMetadataSlot) = delete;
    MetadataSlot& operator= (const MetadataSlot& pMetadataSlot) = delete;
    MetadataSlot& operator= (const MetadataSlot&& pMetadataSlot) = delete;
...
private:
    ...
    MetadataPool(const MetadataPool& pMetadataPool) = delete;
    MetadataPool(const MetadataPool&& pMetadataPool) = delete;
    MetadataPool& operator= (const MetadataPool& pMetadataPool) = delete;
    MetadataPool& operator= (const MetadataPool&& pMetadataPool) = delete;
    ...
    VOID*                           m_pDebugDataBuffer;                     ///< Data store, debug data for all slots.
                                                                            ///  m_numSlots x debug-data  size. Debug-data size
