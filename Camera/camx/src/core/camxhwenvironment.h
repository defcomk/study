...
struct ExternalComponentInfo
{
    ...
    union
    {
        CHINODECALLBACKS            nodeCallbacks;      ///< Node Calllback Interface for Chi to call into custom node.
        CHIAECALGORITHMCALLBACKS    AECAlgoCallbacks;   ///< Algo Calllback Interface for Chi to call into custom node.
        CHIAFALGORITHMCALLBACKS     AFAlgoCallbacks;    ///< Algo Calllback Interface for Chi to call into custom node.
        CHIAWBALGORITHMCALLBACKS    AWBAlgoCallbacks;   ///< Algo Calllback Interface for Chi to call into custom node.
        CHIAFDALGORITHMCALLBACKS    AFDAlgoCallbacks;   ///< Algo Calllback Interface for Chi to call into custom node.
        CHIASDALGORITHMCALLBACKS    ASDAlgoCallbacks;   ///< Algo Calllback Interface for Chi to call into custom node.
        CHIPDLIBRARYCALLBACKS       PDLibCallbacks;     ///< Algo Calllback Interface for Chi to call into custom node.
        CHIISPHVXALGORITHMCALLBACKS HVXAlgoCallbacks;   ///< Algo Calllback Interface for Chi to call into custom node.
    };
