...
{
    ChiPartialCaptureResult partialCaptureMessage[PartialMetadataListSize];  ///< Stream buffers
    UINT                    freeIndex;                                       ///< Next free element in the array
    Mutex*                  pLock;
};
...
struct FlushInfo
{
    UINT64 lastFlushRequestId[MaxPipelinesPerSession];     ///< Request id of the last flushed request
};
...
public:
    ...
    {
        return static_cast<BOOL>(CamxAtomicLoadU8(&m_aFlushStatus) != FALSE);
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// UpdateLastFlushedRequestId
    ///
    /// @brief  Update the lastFlushRequestId with the last submitted request id in each pipeline
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID UpdateLastFlushedRequestId();
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE FlushInfo* GetFlushInfo()
    {
        return &m_flushInfo;
    }
...
protected:
    ...
    ///
    /// @return TRUE if all the results came back, FALSE if we timed out before that.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
private:
    ...
    CAMX_INLINE ChiPartialCaptureResult* GetPartialMetadataMessageDescriptor()
    {
        ...
        pPartialCaptureResultMessage     = &m_PartialDataMessages.partialCaptureMessage[m_PartialDataMessages.freeIndex];

        m_PartialDataMessages.freeIndex  = ((m_PartialDataMessages.freeIndex + 1) % PartialMetadataListSize);
    ...
    ///
    /// @param  pSessionRequest Session capture request info to get the required conditions for syncing the links.
    ///
    /// @return Success if successful
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    BOOL                   m_pWaitAllResultsAvailableSignaled;         ///< indicate that signal is sent.
    ...
    BOOL                  m_isInSyncedLinks[MaxRealTimePipelines];     ///< Per pipeline, to check if it is linked.
    ...
    FlushInfo             m_flushInfo;                                 ///< Contains information of the last flush
    Mutex*                m_pFlushLock;                                ///< Used to halt processing until requests and results
                                                                       ///  have drained
    volatile UINT8        m_aFlushStatus;                              ///< There is a wait active on draining all requests and
                                                                       ///  results. May need to acquire m_pFlushLock to access
                                                                       /// this variable.
    ...
    UINT64                m_longExposureTimeout;                       ///< Long exposure timeout
    UINT64                m_latestLongExposureFrame;                   ///< Latest long exposure frame
