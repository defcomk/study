    ...
    CSLOISI2CInfo* pI2CInfoCmd)
{
    ...
    pI2CInfoCmd->slaveAddr          = m_pOisDriverData->slaveInfo.slaveAddress;
...
UINT OISData::GetInitializeCmdSize()
{
    ...
    totalSize = ImageSensorUtils::GetRegisterSettingsCmdSize(settingsCount, pSettings);
    ...
    VOID*   pCmdBuffer)
{
    ...
    result = ImageSensorUtils::CreateRegisterSettingsCmd(pCmdBuffer, settingsCount, pSettings, I2CFrequencyMode::FAST);
