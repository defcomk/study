...
struct AECEngineAlgorithmOutput
{
    ...
    AECAlgoAdditionalInfo   engineAdditionalControl;    ///< The additional control information output from algorithm
                                                        ///  after processing the stats
...
public:
    ...
    ///                                           value
    /// @param  pUnstabilizedFaceROIInformation   The pointer to UnstabilizedFaceROIInformation
...
private:
    ...
    /// IsAFFocused
    ///
    /// @brief  Check if the AF is focused
    ///
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// SetWarmStartSettings
    ///
    /// @brief  Set warmstart settings
    ///
    /// @param  pHALParam               The pointer AECEngineHALParam to save the HAL parameters
    /// @param  pStatsStreamInitConfig  The pointer to save start up sensitivity values
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID SetWarmStartSettings(
        const AECEngineHALParam* pHALParam,
