...
static const CHAR* pLocalHistProcessLibName = "camera/components/com.qti.stats.localhistogram";

/// @brief Structure describing the HCProcessing information.
struct HCProcessingData
{
    OSLIBRARYHANDLE             hLibHandle;                 ///< Handle to HCprocessing library
    LocalHistCalculationType    pfnLocalHistCalculation;    ///< Function pointer for LocalHistCalculation API
};
...
protected:
    ...
    /// HistNodeProcess
    ///
    /// @brief  Histogram node's main process
    ///
    /// @return CamxResultSuccess if successful
    ///
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CamxResult HistNodeProcess();
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// CHIHistogramProcessEntry
    ///
    /// @brief  Hook the local histogram library into hcProcessing for now
    ///
    /// @param  pHCProcessing  Local histogram preprocessing data
    ///
    /// @return None
    ///
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID CHIHistogramProcessEntry(
...
private:
    ...
    HCProcessingData            m_hcProcessingData;     ///< Local histogram preprocessing data
    LocalHistCalculationParams  m_localHistParams;      ///< Input / Output parameters for function LocalHistCalculation
};
