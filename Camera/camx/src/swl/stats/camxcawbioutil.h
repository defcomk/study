...
public:
    ...
    /// @param  paramType           The AWBAlgoSetParamType of parameter will be set to algorithm
...
private:
    ...
    struct AWBAlgorithmSetInputs
    {
        ...
        VOID*                                   pPeerInfo;                          ///< Holds multi camera peer information
                                                                                    ///  pointer from AWB algorithm
        UnstabilizedFaceROIInformation          unstabilizedFaceInfo;               ///< Payload type of AWB algo set param
