    ...
    const StatsProcessRequestData* pStatsProcessRequestDataInfo)
{
    ...
    CAMX_LOG_VERBOSE(CamxLogGroupAWB, "camera info: algo role: %d, cam id: %d, cam type: %d",
        m_inputs.cameraInfo.algoRole,
        m_inputs.cameraInfo.cameraId,
        m_inputs.cameraInfo.cameraType);
}
    ...
    AWBAlgoSetParamList*           pSetInputList)
{
    ...
    if (NULL != pData[0])
    {
        ...
        pSetInputList->pAWBSetParams[AWBSetParamTypeUnstabilizedFaceROI].setParamType
            = AWBSetParamTypeUnstabilizedFaceROI;
        pSetInputList->pAWBSetParams[AWBSetParamTypeUnstabilizedFaceROI].pAWBSetParam
            = &m_setInputs.unstabilizedFaceInfo;
        pSetInputList->pAWBSetParams[AWBSetParamTypeUnstabilizedFaceROI].sizeOfInputParam
            = sizeof(UnstabilizedFaceROIInformation);
    }
    else
    {
    ...
    AWBAlgoSetParamList*            pSetInputList)
{
    ...
    {
        CAMX_LOG_WARN(CamxLogGroupAWB,
                       "reqId: %llu PropertyIDAECInternal:%p PropertyIDAECFrameInfo:%p not published",
    ...
    else
    {
        ...
        if (NULL != pData[3])
        {
            flashMode = *reinterpret_cast<FlashModeValues*>(pData[3]);
        }
        else
        {
            CAMX_LOG_WARN(CamxLogGroupAWB,
                          "PropertyID %d (FlashMode) has not been published! ",
                          FlashMode);
        }
        ...
        if (CamxResultSuccess == result)
        {
            ...
            pSetInputList->pAWBSetParams[AWBSetParamTypeFlashData].pAWBSetParam     = static_cast<const VOID*>(
                                                                                              &m_setInputs.flashInfo);
    ...
    AWBAlgoSetParamList*            pSetInputList)
{
    ...
    pSetInputList->pAWBSetParams[AWBSetParamTypeDynamicConvergenceSpeed].setParamType     =
        AWBSetParamTypeDynamicConvergenceSpeed;
    pSetInputList->pAWBSetParams[AWBSetParamTypeDynamicConvergenceSpeed].pAWBSetParam     =
        static_cast<const VOID*>(&m_setInputs.dynamicConvergenceSpeed);
    pSetInputList->pAWBSetParams[AWBSetParamTypeDynamicConvergenceSpeed].sizeOfInputParam = sizeof(FLOAT);
    ...
    AWBAlgoSetParamList*            pSetInputList)
{
    ...
    else
    {
        ...
        pSetInputList->pAWBSetParams[AWBSetParamTypeWarmstart].setParamType     = AWBSetParamTypeWarmstart;
        pSetInputList->pAWBSetParams[AWBSetParamTypeWarmstart].pAWBSetParam     =
            static_cast<const VOID*>(&m_setInputs.warmstartInfo);
        pSetInputList->pAWBSetParams[AWBSetParamTypeWarmstart].sizeOfInputParam = sizeof(AWBAlgoWarmstartInformation);
    ...
    if (TRUE == needSync)
    {
        ...
        else
        {
            ...
            CAMX_LOG_VERBOSE(CamxLogGroupAWB, "Peer info: %p, Req:%llu pipeline:%d Peer_Req:%llu Peer_Pipeline:%d",
                             m_setInputs.pPeerInfo, requestID, m_pNode->GetPipelineId(),
                             (requestID - requestDelta), peerPipelineId);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CAWBIOUtil::SetSingleParamToAlgorithm
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult CAWBIOUtil::SetSingleParamToAlgorithm(
    AWBAlgoSetParamList*    pAlgoSetParamList,
    AWBAlgoSetParamType     paramType,
    VOID*                   pParam,
    UINT32                  paramSize)
{
    CAMX_ENTRYEXIT(CamxLogGroupAWB);
    ...
    pAlgoSetParamList->inputParamsCount                                                 = AWBSetParamTypeLastIndex;
    pAlgoSetParamList->pAWBSetParams                                                    = m_setParamInputArray;
    pAlgoSetParamList->pAWBSetParams[paramType].setParamType         = paramType;
    pAlgoSetParamList->pAWBSetParams[paramType].sizeOfInputParam     = paramSize;
    pAlgoSetParamList->pAWBSetParams[paramType].pAWBSetParam         = pParam;
    ...
    AWBAlgoSetParamList*    pAlgoSetParamList)
{
    ...
    if (NULL != pInputTuningModeData)
    {
        ...
        SetSingleParamToAlgorithm(
            pAlgoSetParamList, AWBSetParamTypeChromatixData, static_cast<VOID*>(&m_setInputs.statsTuningData),
            sizeof(StatsTuningData));

        // AWB set camera information
        pAlgoSetParamList->pAWBSetParams[AWBSetParamTypeCameraInfo].setParamType = AWBSetParamTypeCameraInfo;
        pAlgoSetParamList->pAWBSetParams[AWBSetParamTypeCameraInfo].pAWBSetParam =
            static_cast<const VOID*>(&m_inputs.cameraInfo);
        pAlgoSetParamList->pAWBSetParams[AWBSetParamTypeCameraInfo].sizeOfInputParam = sizeof(StatsCameraInfo);
    }
    else
    {
...
{
    m_pStatsAWBPropertyReadWrite->GetReadProperties(AWBReadTypePropertyIDCount);
}
