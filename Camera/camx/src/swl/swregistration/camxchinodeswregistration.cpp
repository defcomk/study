...
const UINT             g_swregistrationOptimalWidth       = 32;
const UINT             g_swregistrationOptimalHeight      = 32;
const UINT             g_swregistrationMaxWidth           = 0xFFF;
const UINT             g_swregistrationMaxHeight          = 0xFFF;
    ...
    CHINODEQUERYBUFFERINFO* pQueryBufferInfo)
{
    ...
    for (UINT inputIndex = 0; inputIndex < pQueryBufferInfo->numInputPorts; inputIndex++)
    {
        ...
        pInputOptions->inputBufferOption.minW     = 0;
        pInputOptions->inputBufferOption.minH     = 0;
        pInputOptions->inputBufferOption.maxW     = g_swregistrationMaxWidth;
        pInputOptions->inputBufferOption.maxH     = g_swregistrationMaxHeight;
        pInputOptions->inputBufferOption.optimalW = g_swregistrationOptimalWidth;
        pInputOptions->inputBufferOption.optimalH = g_swregistrationOptimalHeight;
    }
