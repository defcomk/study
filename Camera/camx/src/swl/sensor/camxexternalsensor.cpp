...
CamxResult ExternalSensor::StreamOn()
{
    ...
    if (CamxResultSuccess == result)
    {
        ...
        CAMX_LOG_VERBOSE(CamxLogGroupSensor, "Stream on Sucessful");
    }
    else
    {
...
CamxResult ExternalSensor::StreamOff()
{
    ...
    if (SensorState::SensorStreamedOn == m_sensorState)
    {
        ...
        if (CamxResultSuccess == result)
        {
            ...
            CAMX_LOG_VERBOSE(CamxLogGroupSensor, "Stream off Sucessful");
        }
        else
        {
...
VOID ExternalSensor::UpdateStartupExposureSettings() {
    ...
    FLOAT   sensitivity  = m_pHwContext->GetStaticSettings()->sensitivity;

    updateParam.currentExposure         = exposureTime;
    updateParam.currentShortExposure    = exposureTime;
    updateParam.currentGain             = sensitivity;
    updateParam.currentShortGain        = sensitivity;
