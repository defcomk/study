...
private:
    ...
    ///
    /// @param  pPDAFLibName PD Library Name to load
    ///
    /// @return CamxResultSuccess
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///
    /// @brief  Utility to check if we are under IHDR processing now
    ///
    /// @return TRUE/FALSE based on stream on state
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE BOOL IsIHDRSnapshotEnabled()
    {
        return ((IHDR_START == m_stateIHDRSnapshot)||
                (IHDR_ENABLED == m_stateIHDRSnapshot))? TRUE: FALSE;
    }

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// IsIHDRSupported
    ///
    /// @brief  If IHDR was supported
    ///
    /// @return TRUE/FALSE
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    BOOL IsIHDRSupported();
    ...
    SensorParam                  m_sensorParam;                      ///< Sensor hardware parameters
    ...
    UINT                         m_updateCmdCount;                   ///< Number of command buffers in update command
    ...
    IHDRSnapshotState            m_stateIHDRSnapshot;                ///< Flag to indicate sensor IHDR state
