...
const FLOAT MaximumToMinimumFPSRatio        = 1.0 / MinimumToMaximumFPSRatio;
...
public:
    ...
    ///
    /// @param  input1      input1 matrix of size 3x3.
    /// @param  input2      input2 matrix of size 3x3.
    /// @param  output      output matrix of size 3x3.
    ///
    /// @return None.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    static CAMX_INLINE VOID MatrixMultiplication3x3(
        FLOAT input1[3][3],
        FLOAT input2[3][3],
        FLOAT output[3][3])
    {
    ...
    {
        return static_cast<INT32>((pSensorDriverData->exposureControlInfo.maxAnalogGain) *
                                  (pSensorDriverData->exposureControlInfo.maxDigitalGain) *
        ...
        FLOAT             ISOMultiplicationFactor)
    {
        ...
        return static_cast<INT32>((pSensorDriverData->exposureControlInfo.minAnalogGain) * ISOMultiplicationFactor);
    }
...
private:
    ...
    ImageSensorUtils(const ImageSensorUtils& other)             = delete;
    ImageSensorUtils& operator=(const ImageSensorUtils& other)  = delete;
};
