...
enum FDManagerThreadJob
{
    ...
    FDManagerThreadJobProcessRequest, ///< Thread job type to process request
};
...
private:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// FDManagerJobProcessRequestHandler
    ///
    /// @brief  Handles frame request jobs received from FDManagerThreadCb function
    ///
    /// @param  pThreadData Pointer to thread data
    ///
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    VOID FDManagerJobProcessRequestHandler(
        FDManagerThreadData* pThreadData);
    ...
    FDEngineHandle          m_hFDEngineFPFilterHandle;              ///< FD Engine handle
